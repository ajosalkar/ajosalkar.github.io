...
(function() {
    ...
    myConnector.getData = function(table, doneCallback) {
     ...
     console.log('Table is : '+table.tableInfo.id);
            ...
            const attendee_URL = 'https://cors-for-wdc.herokuapp.com/https://api.on24.com/v2/client/49268/attendee?startDate=2022-01-03';
            const registrant_URL = 'https://cors-for-wdc.herokuapp.com/https://api.on24.com/v2/client/49268/registrant?startDate=2022-01-03';
             const event_URL = 'https://cors-for-wdc.herokuapp.com/https://api.on24.com/v2/client/49268/event?startDate=2022-01-03';
...
const attendee_promise = ExecuteRequest("https://cors-for-wdc.herokuapp.com/https://api.on24.com/v2/client/49268/attendee?startDate=2022-01-03").then(data => {
...
if(table.tableInfo.id === 'Registrant') {
    ...
    const attendee_promise = ExecuteRequest("https://cors-for-wdc.herokuapp.com/https://api.on24.com/v2/client/49268/registrant?startDate=2022-01-03").then(data => {
...
if(table.tableInfo.id === 'Event') {
  ...
  const event_promise = ExecuteRequest("https://cors-for-wdc.herokuapp.com/https://api.on24.com/v2/client/49268/event?startDate=2022-01-03").then(data => {
